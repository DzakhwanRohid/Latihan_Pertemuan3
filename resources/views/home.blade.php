...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <p class="alert alert-info"><strong>Pesan Motivasi:</strong> {{ $motivation_message }}</p>

        <p><strong>Daftar Hobi:</strong></p>
        ...
        <p><strong>Sisa Waktu Belajar:</strong> <span class="badge text-bg-danger">{{ $time_to_study_left }} hari lagi</span></p>
